...
var SVGCoreVersion = "";
var setSVGCoreVersion = async () => {
  if (SVGCoreVersion) return;
  try {
    const SVGCorePackageJson = await import("./package-ERTZM6PR.js");
...
var SVG_CORE_VERSION = SVGCoreVersion || FA_VERSION;
...
var logger2 = new Logger("FontAwesomeIcon");
var DEFAULT_PROPS = {
  border: false,
  className: "",
  mask: void 0,
...
var FontAwesomeIcon = import_react.default.forwardRef((props, ref) => {
  ...
  if (!iconLookup) {
    logger2.error("Icon lookup is undefined", iconArgs);
    return null;
  }
  ...
  if (!renderedIcon) {
    logger2.error("Could not find icon", iconLookup);
    return null;
  }
